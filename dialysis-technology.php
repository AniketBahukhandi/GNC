...
<head>
    ...
    <title>Diploma in Dialysis Technology - Guru Nanak College, Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Join Guru Nanak College's Diploma in Dialysis Technology. Hands-on training, holistic education, and career-focused learning in Dehradun.">
    <link rel="canonical" href="https://www.gncdehradun.com/dialysis-technology">
    ...
    <meta property="og:description" content="Join Guru Nanak College's Diploma in Dialysis Technology. Hands-on training, holistic education, and career-focused learning in Dehradun." />
    <meta property="og:url" content="https://www.gncdehradun.com/dialysis-technology" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/Dialysis-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Dialysis Technology</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Best Diploma in Dialysis Technology College in India</h2>
                        </div>
                        <p>A diploma in dialysis technology is a
                            program that provides students with the
                            necessary knowledge and skills to operate
                            dialysis equipment and provide assistance
                            to patients who require dialysis. Dialysis is a
                            medical treatment for people who have
                            kidney failure or chronic kidney disease.</p>
                        ...
                        <p>
                            College is providing high-tech well-equipped labs in the departments
                            of Pharmaceutical Chemistry, Pharmaceutics, Pharmacology and
                            Pharmacognosy with analysis of samples for Infrared, UV
                            Spectrophotometric data and HPLC Analysis serve as a strong
                            framework for students to help them develop capabilities to become
                            world-class pharmacists and scientists. The goal of this Programme is
                            to provide adequate depth of understanding of pharmacy principles
                            and also to develop presentation and communication skills, which
                            will add to the confidence in overall managerial abilities to future
                            pharma professionals. The programme also aims at serving the social
                            needs of public, private, corporate, non-corporate and other sectors
                            of the Indian Economy by preparing students for jobs in any field of
                            the Pharmacy profession.
                        </p>
                        <p>The college aims to provide quality
                            pharmacy education to fulfill the requirements of pharmaceutical
                            industry and health care needs of the society at large and achieve
                            excellence in pharmaceutical research. The college exemplifies
                            student centered education, hands-on learning experience and
                            holistic approach. Education at an affordable cost is its highlight.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Diploma in Dialysis Technology.webp">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Join Guru Nanak College of Health Sciences?</h3>
                        </div>
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            ...
                            <li>The institute is abundantly enabled with the provision of rich resource center in the form of :
                                <ul class="list-unstyled p-0 list-icon-4 ps-4 mt-3">
                                    ...
                                    <li>Innovative teaching methodology.</li>
                                </ul>
                            </li>
                            ...
                            <li>Our special focus is on student placements, hence we subject our students to rigorous placement training.</li>
                        </ul>
