...
<head>
    ...
    <title>Bachelors in Optometry - Guru Nanak College, Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Embark on an eye care career with a B. Optom at Guru Nanak College. Comprehensive training, advanced labs, and industry links in Dehradun.">
    <link rel="canonical" href="https://www.gncdehradun.com/optometry">
    ...
    <meta property="og:description" content="Embark on an eye care career with a B. Optom at Guru Nanak College. Comprehensive training, advanced labs, and industry links in Dehradun." />
    <meta property="og:url" content="https://www.gncdehradun.com/optometry" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/optometry-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Optometry (B. Optom)</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Best Bachelor of Optometry (B. Optom) College in India</h2>
                        </div>
                        <p>
                            A Bachelor of Science in Optometry (BSc Optometry) is
                            a four-year undergraduate program designed to train
                            students to become eye care professionals who
                            provide services such as vision testing, prescribing
                            eyeglasses or contact lenses, and diagnosing and
                            treating eye conditions. Optometry is a healthcare field
                            that focuses on the prevention, diagnosis, and
                            treatment of visual problems and disorders.
                        </p>
                        ...
                        <p>
                            College is providing high-tech well-equipped
                            laboratories and advanced medical equipment. This
                            allows students to gain practical experience in a real-
                            world setting, preparing them for their future careers.
                            GNC has strong industry partnerships that provide
                            students with opportunities for internships and
                            placements in leading healthcare institutions. This
                            ensures that students gain exposure to the latest
                            technologies and trends in the field, making them
                            highly sought-after professionals. Education at an
                            affordable cost is its highlight.ience and holistic
                            approach. Education at an affordable cost is its
                            highlight.
                        </p>
                        <p>The curriculum of a BSc Optometry program typically
                            includes courses in anatomy, physiology, optics,
                            pharmacology, binocular vision, and ocular disease.
                            Students also receive clinical training in optometry
                            procedures and techniques, including refraction,
                            contact lens fitting, and visual rehabilitation.</p>
                ...
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Bachelor of Optometry.webp">
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            <li>Minimum qualification required is 10+2 from science stream.</li>
