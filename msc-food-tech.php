...
<head>
    ...
    <title>M.Sc. in Food Technology at Guru Nanak College - Mastering the Art of Food Science</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Advance your expertise in the evolving field of food science with an M.Sc. in Food Technology from Guru Nanak College, Dehradun - a program designed to blend culinary innovation with technological sophistication.">
    <link rel="canonical" href="https://gncdehradun.com/msc-food-tech">
    ...
    <meta property="og:description" content="Embark on a Food Tech career with MSc Food Tech at Guru Nanak College. In-depth education and hands-on experience in a nurturing environment." />
    <meta property="og:url" content="https://gncdehradun.com/msc-food-tech"/>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/MSc-FoodTechnology-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Science in Food Technology</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>The Master of Science in Food Technology program at Guru Nanak College, Dehradun</h2>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Master of Science in Food Tech .webp">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            <li>Minimum qualification required is graduation from any recognized university.</li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Join the M.Sc. Food Technology Program at Guru Nanak College, Dehradun?</h3>
                        </div>
