...
<head>
    ...
    <title>Bachelor of Physiotherapy | Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Join Guru Nanak College's Bachelor of Physiotherapy program. Comprehensive training for a fulfilling career in rehabilitative health science.">
    <link rel="canonical" href="https://www.gncdehradun.com/physiotherapy">
    ...
    <meta property="og:description" content="Join Guru Nanak College's Bachelor of Physiotherapy program. Comprehensive training for a fulfilling career in rehabilitative health science." />
    <meta property="og:url" content="https://www.gncdehradun.com/physiotherapy" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/physiotherapy-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Physiotherapy</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Best Bachelor of Physiotherapy College in India</h2>
                        </div>
                        ...
                        <p>The Bachelor of Physiotherapy (BPT) degree equips graduates with a diverse range of career opportunities in the healthcare sector. These professionals are highly sought after in hospitals and clinics, especially in rehabilitation departments. Here, they play a pivotal role in helping patients recover from surgeries, injuries, or manage chronic conditions, focusing on improving mobility and alleviating pain.</p>
                        <p>Private practice is another popular avenue for BPT graduates. In this setting, they have the opportunity to provide personalized care, addressing various musculoskeletal and neurological issues on an individual basis. This path allows for a more customized approach to physiotherapy, catering to the specific needs of each patient.</p>

                    </div>
                </div>
                <div class="col-lg-6">
                <iframe width="560" height="350" src="https://www.youtube.com/embed/Dp6mtdGQPRo?autoplay=1&mute=1&playlist=Dp6mtdGQPRo&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <!-- <div class="col-lg-6">
