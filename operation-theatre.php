...
<head>
    ...
    <title>Operation Theater Course - Guru Nanak College, Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Enhance your skills with the Operation Theater Course at Guru Nanak College. Expert training for a successful career in medical support in Dehradun.">
    <link rel="canonical" href="https://www.gncdehradun.com/operation-theater">
    ...
    <meta property="og:description" content="Enhance your skills with the Operation Theater Course at Guru Nanak College. Expert training for a successful career in medical support in Dehradun." />
    <meta property="og:url" content="https://www.gncdehradun.com/operation-theater" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/Operation_Theatre_head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Operation Theatre Technology (BOTT)</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Bachelor of Operation Theatre Technology (BOTT)</h2>
                        </div>
                        <p>The Bachelor of Operation Theatre Technology (BOTT) is a specialized undergraduate program designed for those aspiring to be integral members of surgical teams in healthcare settings. This course offers in-depth knowledge and hands-on training in managing operation theaters, understanding surgical procedures, handling sophisticated equipment, and assisting in complex surgeries. Students learn crucial aspects of anesthesia technology, surgical instrumentation, patient monitoring, and operation theater management, ensuring a sterile and safe environment during surgeries.</p>
                        <p>Many BOTT graduates find their niche in administrative roles, such as Hospital Operation Theatre Managers, overseeing the operation theater department, managing staff, and ensuring compliance with healthcare regulations. Their in-depth knowledge of operation theater technology also makes them valuable consultants for medical equipment manufacturers, contributing to the design and functionality of surgical tools.</p>
                        ...
                        <p>Graduates of the Bachelor of Operation Theatre Technology (BOTT) have a diverse range of career opportunities in the healthcare sector. As Operation Theatre Technologists, they are pivotal in assisting surgeons and anesthesiologists, managing surgical equipment, and maintaining sterile conditions in operation theaters. Their expertise is also crucial in roles such as Surgical Equipment Technicians, where they handle the maintenance and operation of sophisticated surgical tools.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Bachelor of Operation Theatre Technology .webp">
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-6">
...
<ul class="list-unstyled p-0 list-icon-3 ps-4">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="list-unstyled p-0 list-icon-3 ps-4">
                <li>Admission to our program is determined by a merit-based selection process, which takes into account the marks obtained in the qualifying examination. Additionally, the university conducts Counselling with all applicants to assess their eligibility for admission.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Choose Guru Nanak College School of Paramedical Sciences?</h3>
                        </div>
                        <p>School of Paramedical Sciences, part of the esteemed Guru Nanak College, Dehradun we are dedicated to providing top-tier education in health sciences. </p>
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
