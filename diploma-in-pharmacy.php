...
<head>
    ...
    <title>Diploma in Pharmacy (D.Pharma) - Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Enroll in Guru Nanak College's D.Pharma for in-depth pharmaceutical studies and practical experience, paving the way for a successful pharmacy career.">
    <link rel="canonical" href="https://www.gncdehradun.com/diploma-in-pharmacy">
    ...
    <meta property="og:description" content="Enroll in Guru Nanak College's D.Pharm for in-depth pharmaceutical studies and practical experience, paving the way for a successful pharmacy career."/>
    <meta property="og:url" content="https://www.gncdehradun.com/diploma-in-pharmacy"/>
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/d-pharma.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Pharmacy (D.Pharm)</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>In the first year, students are introduced to the basics of medicinal chemistry, human anatomy and physiology, and the principles of biochemistry. This foundation is crucial for understanding the complexities of drug formulation and action. The second year delves deeper into pharmaceutical laws and ethics, drug interactions, and the preparation and dispensing of medications.</p>
                        ...
                        <p>Graduates of the Diploma in Pharmacy (D.Pharm) program can explore several career paths in the pharmaceutical and healthcare sectors. They can work as Pharmacy Technicians, supporting pharmacists in dispensing medications and providing patient care. Another avenue is as Medical Representatives, where they promote and sell pharmaceutical products. Opportunities also exist in clinical research as assistants, contributing to the management and execution of clinical trials. Additionally, they can find roles in drug manufacturing and quality control, ensuring the safety and efficacy of pharmaceutical products. These diverse career options reflect the practical and versatile nature of the D.Pharm qualification. </p>
                    </div>
                </div>
                <div class="col-lg-6">
                <iframe width="560" height="350" src="https://www.youtube.com/embed/3bVTeWA9mjU?autoplay=1&mute=1&playlist=3bVTeWA9mjU&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    ...
                    <div class="bigInfo-section__content pt-8 pb-8">
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            ...
                            <li>Students benefit from:
                                <ul class="list-unstyled p-0 list-icon-4 ps-4 mt-3">
                                    <li>A well-stocked, centrally managed library with extensive pharmaceutical resources.  </li>
                                    <li>Modern laboratories equipped with the latest technology for practical and research-based learning.</li>
                                    <li>A faculty of highly qualified and experienced professionals in the field of pharmacy.</li>
                                    <li>Innovative teaching methods that blend traditional approaches with modern techniques in pharmaceutical education.</li>
                                </ul>
                            </li>
