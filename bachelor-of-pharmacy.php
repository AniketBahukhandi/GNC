...
<head>
    ...
    <title>Bachelor of Pharmacy Program - Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Discover the Bachelor of Pharmacy at Guru Nanak College, Dehradun. A comprehensive curriculum for a successful career in the pharmaceutical sector.">
    <link rel="canonical" href="https://www.gncdehradun.com/bachelor-of-pharmacy">
    ...
    <meta property="og:description" content="Discover the Bachelor of Pharmacy at Guru Nanak College, Dehradun. A comprehensive curriculum for a successful career in the pharmaceutical sector."/>
    <meta property="og:url" content="https://www.gncdehradun.com/bachelor-of-pharmacy"/>
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/bachelor-of-pharmacyhead.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Pharmacy</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Bachelor of Pharmacy.webp">
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why join School of Pharmacy at Guru Nanak College, Dehradun?</h3>
                        </div>
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            ...
                            <li>Students benefit from:
                                <ul class="list-unstyled p-0 list-icon-4 ps-4 mt-3">
                                    ...
                                    <li>Modern laboratories equipped with the latest technology for practical and research-based learning.s</li>
