...
<head>
    ...
    <title>BSc Nursing Degree - Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Embark on a nursing career with BSc Nursing at Guru Nanak College. In-depth education and hands-on experience in a nurturing environment.">
    <link rel="canonical" href="https://www.gncdehradun.com/bsc-nursing">
    ...
    <meta property="og:description" content="Embark on a nursing career with BSc Nursing at Guru Nanak College. In-depth education and hands-on experience in a nurturing environment." />
    <meta property="og:url" content="https://www.gncdehradun.com/bsc-nursing" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/bsc-nursing-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Science in Nursing</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>After completing a Bachelor of Science in Nursing (BSc Nursing), graduates can pursue various career paths. They can become Registered Nurses (RNs) in hospitals, clinics, or community centers, providing direct patient care. With additional training, they can specialize in fields like pediatrics or oncology. Experienced nurses may advance to managerial roles, overseeing departments and policies. Opportunities also exist in public health, education, and research, where nurses contribute to broader health initiatives, teach future nurses, or engage in healthcare studies. Additionally, some may opt for travel nursing, offering care in diverse locations, or become legal nurse consultants, bridging healthcare and legal sectors.</p>

                    </div>
                </div>
                <div class="col-lg-6">
                <iframe width="560" height="350" src="https://www.youtube.com/embed/WgPpWfNyinI?autoplay=1&mute=1&playlist=WgPpWfNyinI&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><b>Net Academic Fee (Included all Fees)</b></td>
                                                        <td><b>2,25,000</b></td>
                                                    </tr>
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        <td colspan="2">Total Fee year wise Inculuded all other charges</td>
                                                        <td>2,25,000</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Choose Guru Nanak College School of Nursing?</h3>
                        </div>
                        <p>
                            At the School of Nursing, a part of the renowned Guru Nanak College in Dehradun, we commit ourselves to delivering exceptional education in nursing sciences. </p>
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            <li>Our aim is to cultivate proficient professionals who are well-prepared to meet global healthcare challenges.
                            </li>
                            <li>The campus boasts state-of-the-art educational facilities, fostering a well-rounded learning environment.
                            <li>Students benefit from:</li>
                            <ul class="list-unstyled p-0 list-icon-4 ps-4 mt-3">
                                <li>A rich, centrally managed library with extensive resources.</li>
                                <li>Modern laboratories, outfitted with cutting-edge technology.</li>
                                <li>A faculty comprising highly qualified and seasoned professionals.</li>
                                <li>An innovative teaching approach that blends traditional methods with modern techniques.</li>
                            </ul>
                            </li>
