...
<head>
    ...
    <link rel="canonical" href="https://www.gncdehradun.com/d-health-administration">
    ...
    <meta property="og:url" content="https://www.gncdehradun.com/d-health-administration" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/diploma--head.webp ) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Health Administration</h1>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        ...
                        <p>Graduates of the DHA program can explore a variety of career paths within the hospital sector. They are prepared to take on roles such as Hospital Administrators, managing the day-to-day operations of hospital facilities; Hospital Consultants, offering strategic advice to improve hospital services; Policy Analysts, shaping hospital policies; and Managers in hospital-related NGOs or community hospital organizations. This course also lays the groundwork for those interested in pursuing higher education and specialized roles in hospital management.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Diploma in Health Administration.webp">
                        </div>
                    </div>
                </div>
            </div>
...
<ul class="list-unstyled p-0 list-icon-3 ps-4">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="list-unstyled p-0 list-icon-3 ps-4">
                <li>The admission process for the DHA program at Guru Nanak College, Dehradun, primarily evaluates candidates based on their academic background, with an emphasis on previous studies in hospital or related fields.</li>
                <li>The college may also conduct counseling sessions to ascertain applicants' understanding of hospital systems and their motivation for pursuing a career in hospital administration.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        ...
                        <p>At Guru Nanak College, Dehradun, we are committed to delivering an exceptional education in hospital administration.</p>
                        <p>Our program stands out for its:</p>
                        <ul class="list-unstyled p-0 list-icon-4 ps-4 mt-3">
                            <li>Comprehensive library, rich in resources on hospital administration and policy.</li>
                            <li>State-of-the-art facilities, including modern classrooms and technology-equipped labs for practical learning.</li>
                            <li>A faculty of experienced hospital professionals and academicians, bringing valuable insights from the field.</li>
                            <li>An innovative approach to education, blending core hospital administration concepts with the latest trends and practices in hospital management.</li>
                        </ul>
                        <p>We aim to foster not just academic proficiency but also critical thinking, ethical decision-making, and leadership skills in our students. Understanding the dynamic nature of the hospital industry, we provide extensive training for placements, preparing our students to meet the challenges of the hospital sector and to excel in their chosen career paths in hospital administration.</p>
