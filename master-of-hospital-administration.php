...
<head>
    ...
    <title>Master of Hospital Administration| Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Join Guru Nanak College's Master of Hospital Administration program. Comprehensive training for a fulfilling career in rehabilitative health science.">
    <link rel="canonical" href="https://www.gncdehradun.com/master-of-hospital-administration">
    ...
    <meta property="og:description" content="Join Guru Nanak College's Master of Hospital Administration program. Comprehensive training for a fulfilling career in rehabilitative health science." />
    <meta property="og:url" content="https://www.gncdehradun.com/master-of-hospital-administration" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/master-of-hospital-administration-head.webp) ;">
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Best Master of Hospital Administration College in India</h2>
                        </div>
                        ...
                        <p>After completing a Master of Hospital Administration (MHA), graduates can pursue careers in hospital and healthcare facility management, healthcare consulting, health policy analysis, health services management, and quality and patient safety coordination. They are also well-suited for roles in healthcare financial management, human resources, health information systems, and public health administration. Additionally, MHA graduates are equipped to lead in pharmaceutical project management and healthcare marketing, using their expertise to drive project success and improve public health messaging. High-level executive positions like hospital CEO or CFO are also achievable goals for MHA graduates, where they can make significant strategic decisions impacting healthcare delivery and operations.</p>
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            <li>Minimum qualification required is graduation in any stream from any recognized board.</li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Choose Guru Nanak College School of Health Sciences?</h3>
                        </div>
                        <p>School of Health Sciences, part of the esteemed Guru Nanak College, Dehradun we are dedicated to providing top-tier education in health sciences.</p>
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
