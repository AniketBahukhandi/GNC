...
<head>
    ...
    <title>Diploma in Hotel Management - Guru Nanak College Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Explore a career in hospitality with Guru Nanak College's Hotel Management Diploma. Practical training and industry insights for a thriving future.">
    ...
    <meta property="og:description" content="Explore a career in hospitality with Guru Nanak College's Hotel Management Diploma. Practical training and industry insights for a thriving future."/>
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/diploma-management-head.webp ) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Hotel Management</h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Diploma in Hotel Management.webp">
                        </div>
                    </div>
                </div>
            </div>
...
<ul class="list-unstyled p-0 list-icon-3 ps-4">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="list-unstyled p-0 list-icon-3 ps-4">
                <li>The admission process for a Diploma in Hotel Management (DHM) program that offers direct admission based on 10th/12th-grade marks selection process, which takes into account the marks obtained in the qualifying examination.</li>
            </ul>
        </div>
    </section>
