...
<head>
    ...
    <title>B.Sc. in Microbiology at Guru Nanak College - Exploring the Microscopic World</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Dive into the fascinating world of microorganisms with a B.Sc. in Microbiology from Guru Nanak College, Dehradun - a journey to understanding life's intricate details and their vast applications.">
    <link rel="canonical" href="https://gncdehradun.com/bsc-microbiology">
    ...
    <meta property="og:description" content="Dive into the fascinating world of microorganisms with a B.Sc. in Microbiology from Guru Nanak College, Dehradun - a journey to understanding life's intricate details and their vast applications." />
    <meta property="og:url" content="https://gncdehradun.com/bsc-microbiology" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/bsc-Microbiology-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Science in Microbiology </h1>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Bachelor of Science in Microbiology </h2>
                        </div>
                        <p>The Bachelor of Science in Microbiology program at the School of Life & Allied Sciences, Guru Nanak College, Dehradun, is an undergraduate course designed for students interested in the study of microorganisms and their impact on humans, animals, plants, and the environment. This three-year program provides comprehensive knowledge about the biology of bacteria, viruses, fungi, and other microorganisms. It covers various aspects of microbiology including immunology, virology, bacteriology, mycology, and molecular biology.</p>
                        <p>The curriculum is structured to offer both theoretical and practical insights into the world of microscopic organisms. Students learn about microbial genetics, bioinformatics, pathogenic microbiology, and environmental microbiology. The program also includes laboratory work, where students get hands-on experience in microbiological techniques and experiments, preparing them for real-world applications.</p>
                        ...
                        <p>Graduates with a B.Sc. in Microbiology have a wide range of career options. They can pursue roles in clinical research organizations, pharmaceutical companies, food and beverage industries, and agricultural sectors. Careers in healthcare as clinical microbiologists or in diagnostic laboratories are common, where they play a crucial role in identifying pathogens and developing treatments. Opportunities also exist in research institutions and universities, where they can contribute to scientific research in genetics, biochemistry, and molecular biology. Further, graduates can find employment in environmental agencies, focusing on environmental monitoring and bioremediation. Advanced studies in microbiology or related fields can lead to academic or research-based careers.</p>
                ...
                <div class="col-lg-6">
                    <div class="specialization-slider pagination-style-1">
                        <div class="specialization-slider__item">
                            <img src="upload/Bachelor of Science in Microbiology .webp">
                        </div>
                    </div>
                </div>
                <!-- <div class="col-lg-6">
...
<ul class="list-unstyled p-0 list-icon-3 ps-4">
    ...
    <section class="pt-5 pb-5 admissionProcess">
        <div class="container">
            ...
            <ul class="list-unstyled p-0 list-icon-3 ps-4">
                <li>Admission to the B.Sc. Microbiology program at the School of Life & Allied Sciences, Guru Nanak College, Dehradun, is based on academic merit.</li>
                <li>The selection process involves evaluating the applicant's marks in their 10+2 examination, particularly in science subjects. The college may also conduct a counseling process to assess the candidates' interest in microbiology and their aptitude for scientific studies.</li>
            </ul>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="bigInfo-section__content pt-8 pb-8">
                        <div class="page-heading">
                            <h3>Why Choose Guru Nanak College School of Microbiology ?</h3>
                        </div>
