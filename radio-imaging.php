...
<head>
    ...
    <title>Bachelors in Radio Imaging - Guru Nanak College, Dehradun</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Master medical imaging with Guru Nanak College's BMRIT program. Advanced training and diverse career paths in healthcare imaging in Dehradun.">
    <link rel="canonical" href="https://www.gncdehradun.com/radio-imaging">
    ...
    <meta property="og:description" content="Master medical imaging with Guru Nanak College's BMRIT program. Advanced training and diverse career paths in healthcare imaging in Dehradun." />
    <meta property="og:url" content="https://www.gncdehradun.com/radio-imaging" />
...
<body>
    ...
    <div class="kingster-page-title-wrap  kingster-style-custom kingster-left-align" style="background-image: url(upload/radio-imaging-head.webp) ;">
        ...
        <div class="kingster-page-title-container kingster-container">
            <div class="kingster-page-title-content kingster-item-pdlr" style="padding-top: 560px ;padding-bottom: 60px ;">
                ...
                <h1 class="kingster-page-title" style="font-size: 48px ;font-weight: 700 ;text-transform: none ;letter-spacing: 0px ;color: #ffffff ;">Medical Radio Diagnosis And <br>Imaging Technology</h1>
            </div>
        </div>
    </div>
    <section class="aboutProgram-section pt-8 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="aboutProgram-section__content">
                        <div class="page-heading">
                            <h2>Best Bachelor of Medical Radio Diagnosis And Imaging Technology College in India</h2>
                        </div>
                        <p>A Bachelor of Medical Radio Diagnosis And Imaging Technology
                            (BMRIT) is a three-year undergraduate program
                            designed to train students to become medical
                            imaging professionals who operate and maintain
                            medical imaging equipment. Medical imaging is a
                            field in healthcare that involves the use of
                            technology to create images of the body for
                            diagnostic and treatment purposes.</p>
                        ...
                        <p>Graduates of the Bachelor of Medical Radio Diagnosis And Imaging Technology (BMRIT) have diverse career opportunities in healthcare, focusing on medical imaging and diagnostics. They are primarily employed in hospitals, operating imaging equipment like MRI and CT scanners, playing a crucial role in patient diagnosis. Additionally, diagnostic centers and outpatient clinics are significant employers, where BMRIT graduates collaborate with radiologists to interpret imaging results.</p>
                        <p>Beyond conventional roles, graduates can specialize in areas like interventional radiology or mammography, often requiring further training. The field also offers prospects in research and development, contributing to advancements in imaging technology.</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <iframe width="560" height="350" src="https://www.youtube.com/embed/HiXcKSz8fJM?autoplay=1&mute=1&playlist=HiXcKSz8fJM&loop=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
                <!-- <div class="col-lg-6">
    ...
    <section class="fees-section  pb-8">
        <div class="container">
            <div class="page-heading">
                ...
                <div class="col-lg-4">
                    <div class="eligibility-block">
                        ...
                        <ul class="list-unstyled p-0 list-icon-3 ps-4">
                            ...
                            <li>Minimum percentage required is 50% for GEN/OBC and 45% for SC/ST.</li>
                        </ul>
